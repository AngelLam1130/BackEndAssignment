...
function addAbilityToLogin(_ref) {
  ...
  appEl.addEventListener("submit", function (e) {
    ...
    (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchLogin)(username).then(function (_ref2) {
      var _console;
      var onlineUsers = _ref2.onlineUsers,
        messageList = _ref2.messageList;
      (0,_state__WEBPACK_IMPORTED_MODULE_2__.login)(username);
      (0,_state__WEBPACK_IMPORTED_MODULE_2__.setUsers)(onlineUsers);
      (0,_state__WEBPACK_IMPORTED_MODULE_2__.setMessages)(messageList);
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("4270549187_19_8_19_32_4", messageList)));
...
function addAbilityToSendMessage(_ref4) {
  ...
  appEl.addEventListener("submit", function (e) {
    ...
    e.preventDefault();
    var message = e.target.querySelector(".message-send__input").value;
    (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchSendMessage)(message).then(function (messages) {
...
function render(_ref) {
  var state = _ref.state,
    appEl = _ref.appEl;
  var html = "\n    ".concat(generateLoginHtml(state), "\n    ").concat(generateChatPageHtml(state), "\n  ");
...
function generateChatPageHtml(state) {
  ...
  return "<section class=\"chat-page\">\n  ".concat(generateUsersHtml(state), "\n  ").concat(generateChatsHtml(state), "\n  ").concat(generateAddHtml(), "\n</section>");
}
function generateUsersHtml(state) {
  return "<ol class=\"users\">" + Object.values(state.users).map(function (user) {
    return "<li class=\"user\">\n          <span class=\"username\">".concat(user, "</span>\n        </li>");
  }).join("") + "\n      <li class=\"user-item\">\n        <button type=\"button\" class=\"logout\">Logout</button>\n      </li>\n    </ol>";
}
function generateChatsHtml(state) {
  return "<ol class=\"messages\">" + Object.values(state.messages).map(function (message) {
    return "\n      <li class=\"message\">\n        <i class=\"user-icon\"></i>\n        <div class=\"message-info\">\n          <span class=\"message-sender\"> sender: ".concat(message.sender, "</span>\n          <p class=\"message-text\">text: ").concat(message.text, "</p>\n        </div>\n      </li>");
  }).join("") + "</ol>";
}
...
function fetchSession() {
  return fetch('/api/session').then(function (r) {
    return r.json();
  }).then(function (data) {
    if (data.error) {
      throw data;
...
function fetchUsers() {
  return fetch('/api/users').then(function (r) {
    return r.json();
  }).then(function (data) {
    if (data.error) {
      throw data;
...
function fetchMessages() {
  return fetch('/api/messages').then(function (r) {
    return r.json();
  }).then(function (data) {
    if (data.error) {
      throw data;
...
function setError(error) {
  var _console;
  /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("796104745_51_2_51_20_4", error)));
  if (!error) {
    state.error = '';
    return;
  }
...
function checkForSession() {
  (0,_services__WEBPACK_IMPORTED_MODULE_0__.fetchSession)().then(function (session) {
    (0,_state__WEBPACK_IMPORTED_MODULE_2__.login)(session.username);
